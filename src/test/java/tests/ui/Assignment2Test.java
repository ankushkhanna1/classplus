...
import in.novopay.platform_ui.pages.web.Assignment2Page;
import in.novopay.platform_ui.utils.BasePage;
import in.novopay.platform_ui.utils.JavaUtils;

public class Assignment2Test {
	String featureName = "Assignment2";
	public static WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private Assignment2Page wAssignment2Page;
	private Map<String, String> usrData;
	public String sheetname = "Assignment2Page", workbook = "TestData";
	...
	public void assignment2Test(HashMap<String, String> usrData) throws ClassNotFoundException, InterruptedException {
		...
		wAssignment2Page = new Assignment2Page(wdriver);
		wAssignment2Page.assignment2(usrData);
	}
